...
- **CE sync/export:** Use `ce-sync` as the supported wrapper for repeatable compound-engineering exports and refreshes. It orchestrates the existing installer; do not invent a second export format.
...
- Use `ce-sync` for repeatable exports/refreshes of compound-engineering skills; it is the supported wrapper around the installer, not a second export format.
