...
| [On demand](docs/guides/README.md#on-demand) | `ce-ideate` `ce-bakeoff` `ce-pov` `ce-debug` `ce-explain` `ce-doc-review` `ce-plan-grounding-check` `ce-optimize` `ce-prototype` | Reached for when a specific need arises |
