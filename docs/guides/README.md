...
| [`/ce-plan-grounding-check`](./ce-plan-grounding-check.md) | Disk-vs-document review: named files, fixtures, and pipelines must exist as claimed before `implementation-ready` |
