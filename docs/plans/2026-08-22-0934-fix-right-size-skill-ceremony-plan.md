...
- R6. Pipeline and headless runs, any run where no synchronous user can act on chat output this turn, and any request that explicitly asks for a plan file or an output format select Durable.
