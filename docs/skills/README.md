...
| [`/ce-quick-ship-pr`](./ce-quick-ship-pr.md) | Routine review-commit-push-open-PR path with explicit file scope, light verification, and no merge/deploy side effects |
