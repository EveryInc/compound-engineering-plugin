...
- **framework_version** (string): Framework version (e.g., "React 18.2", "Next.js 14.0")
...
5. framework_version (if provided) should include framework name and version
...
framework_version: "Next.js 14.0"
