...
Reference the complete [EVERY_WRITE_STYLE.md](${CLAUDE_PLUGIN_ROOT}/skills/every-style-editor/references/EVERY_WRITE_STYLE.md) for specific rules when in doubt.
...
The complete Every style guide is included in [EVERY_WRITE_STYLE.md](${CLAUDE_PLUGIN_ROOT}/skills/every-style-editor/references/EVERY_WRITE_STYLE.md). Key areas to focus on:
