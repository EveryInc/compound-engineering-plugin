...
|-------------|----------|
| `src/app/users/*` | `/users`, `/users/:id`, `/users/new` |
| `src/app/settings/*` | `/settings` |
| `src/components/*` | Pages using those components |
| `src/app/layout.tsx` | All pages (test homepage at minimum) |
| `src/app/globals.css` | Visual regression on key pages |
| `src/lib/*` | Pages using those utilities |
| `src/app/api/*` | API routes (test via fetch) |
