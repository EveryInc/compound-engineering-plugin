...
### 7. **Optional: Specialized Agent Invocation** (Post-Documentation)
   ...
   - Any code-heavy issue → `nextjs-reviewer` + `code-simplicity-reviewer`
...
Specialized Agent Reviews (Auto-Triggered):
  ...
  ✓ nextjs-reviewer: Code examples meet Next.js standards
...
### Code Quality & Review
- **nextjs-reviewer**: Reviews code examples for Next.js best practices
...
- **framework-docs-researcher**: Links to Next.js/npm package documentation references
