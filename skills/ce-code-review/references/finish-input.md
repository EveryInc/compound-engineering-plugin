...
This is Stage 5b step 4; `finish-review.md` points here for it. Build the batch prompt from `validator-input.json` with `references/validator-batch-template.md`, then:
