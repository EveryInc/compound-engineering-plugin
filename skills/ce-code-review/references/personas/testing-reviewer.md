...
If you use mutation testing (edit a production file, run the suite, revert), do it only in an isolated worktree or a scratch copy. Never mutate the shared checkout the rest of the reviewer batch is reading.
