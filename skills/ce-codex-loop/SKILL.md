...
4. **Implementation.** Invoke `ce-work mode:implementation-only <canonical-plan-path>` and require a structured implementation result. `already_satisfied` is terminal only when it includes proof and identified files.
