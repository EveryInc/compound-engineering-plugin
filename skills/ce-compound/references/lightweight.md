...
The orchestrator (main conversation) performs ALL of the following in one sequential pass. Any later doc or glossary correction repeats the scratch draft, `allow-write`, and `commit-write` sequence:
