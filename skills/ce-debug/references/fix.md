...
4. Verify the test passes, then re-run Phase 1's reproduction check against the original scenario (not only the minimized or test-shaped one), then run the broader suite for regressions.
