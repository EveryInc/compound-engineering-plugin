...
Synthesis drops anchors `0` and `25` silently; anchor `50` routes to the FYI subsection; anchors `75` and `100` both enter the actionable tier, where your `autofix_class` — not the anchor — decides which surface the finding lands on.
