...
<One Mermaid flowchart per journey — entry, actions, branch points, side effects, true end state including click-through destination.>
...
<One line per paper cut. "None" if clean.>
