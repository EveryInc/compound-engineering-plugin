...
How an explainer renders as markdown — the fallback format when intake resolved `output:md`. Content rules match the HTML reference; only the presentation medium differs.
