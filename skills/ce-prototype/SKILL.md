...
After they proceed, speak only when they can act on something new, in one short line naming what happened. A screen is up, the helper URL is live, or a blocker only they can lift, are such boundaries. The annotation loop owns the line after an applied revision and silence while a wait is parked.
