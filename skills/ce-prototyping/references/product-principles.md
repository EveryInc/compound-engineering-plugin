...
1. **Repo copy** — `.compound-engineering/product-principles.md` in the working directory (the active, gating copy; versioned with the repo, shareable with the team).
...
- Write the repo copy at `.compound-engineering/product-principles.md`.
