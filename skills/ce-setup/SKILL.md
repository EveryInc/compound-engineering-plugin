...
All paths there resolve from the repository root (`git rev-parse --show-toplevel`), not the current working directory, and nothing is written without the user's approval.
