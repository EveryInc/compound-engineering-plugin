...
This is NOT a replacement for MEMORY.md (which handles decisions and patterns) or the CE artifact root's `solutions/` tree (which handles post-hoc learnings). SESSION_STATE.md captures **live progress** — what branch you're on, what plan you're executing, which tasks are done, and what's next.
...
**Plan:** <root>/plans/2026-04-21-001-feat-user-auth-flow-plan.md
