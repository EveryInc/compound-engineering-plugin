...
2. **Code-quality review** — Only after spec-compliance passes. Dispatch a generic subagent seeded with the local prompt asset `references/agents/code-quality-per-task-reviewer.md` from this skill's directory. Is the code clean, tested, and maintainable?
