...
// ce-resolve-pr-feedback is deliberately absent: its frontmatter pins
// allowed-tools to Bash(gh *), Bash(git *), Read, so a bundled node
// invocation cannot run there pre-approved.
